...
public class Rating implements NodeServicePolicies.OnDeleteNodePolicy, NodeServicePolicies.OnCreateNodePolicy {
	...
	public void init() {
		...
		this.policyComponent.bindClassBehaviour(OnCreateNodePolicy.QNAME, SomeCoModel.TYPE_RATING, this.onCreateNode);
		this.policyComponent.bindClassBehaviour(OnDeleteNodePolicy.QNAME, SomeCoModel.TYPE_RATING, this.onDeleteNode);
	}
	...
	public void onDeleteNode(ChildAssociationRef childAssocRef, boolean isNodeArchived) {
		if (childAssocRef != null && nodeService.exists(childAssocRef.getParentRef()))
