   ...
   <#if form.mode == "view">
      <div class="viewmode-field">
         ...
         <span class="viewmode-value">
         	<#if valueToShow == "Red"><img src="${url.context}/res/components/form/images/trafficlight-red-32.png"
         	<#elseif valueToShow == "Yellow"><img src="${url.context}/res/components/form/images/trafficlight-yellow-32.png"
         	<#else><img src="${url.context}/res/components/form/images/trafficlight-green-32.png"
         	</#if>
         </span>
      </div>
   <#else>
