      ...
      <body>
         ...
         <table>
            <#list whitepapers as child>
               ...
               <tr>
                  <td><b>Title</b></td>
                  <td><#if child.whitepaper.properties["cm:title"]?exists>${child.whitepaper.properties["cm:title"]}</#if></td>
               </tr>
               <tr>
                  <td><b>Link</b></td>
               ...
               <tr>
                  ...
                  <td><p><#if child.whitepaper.properties["cm:description"]?exists && child.whitepaper.properties["cm:description"] != "">${child.whitepaper.properties["cm:description"]}</#if></p></td>
               </tr>
               <tr>
                  <td><b>Pub Date</b></td>
               ...
               <tr>
                  ...
                  <td>
                     <table>
                        <tr>
                           <td><b>Average</b></td><td>${child.rating.average!0}</td>
                        </tr>
                        <tr>
                           <td><b>Count</b></td><td>${child.rating.count!0}</td>
                        </tr>
